...
test(cards,[]) :- 
    ...
    Translated == b_machine([definitions([predicate_definition(none,this/'ThreeOfAKind',[identifier(none,hand)],conjunct(none,conjunct(none,equal(none,card(none,identifier(none,hand)),integer(none,3)),equal(none,card(none,join(none,identifier(none,hand),identifier(none,suit))),integer(none,1))),member(none,identifier(none,hand),identifier(none,'Card'))))]),sets([identifier(none,this/'Suit'),identifier(none,this/'Card')]),properties([conjunct(none,member(none,identifier(none,suit),identifier(none,'Suit')),equal(none,card(none,identifier(none,suit)),integer(none,1)))]),constants([]),assertions([]),operations([])]).

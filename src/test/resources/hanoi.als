...
/* Note: Alloy 4.1.10 takes 119ms + 5912 ms on MacBookPro 3.06 Ghz with minisat to solve Game1 with 5 discs

Executing "Run Game1 for 1 but 3 Stake, 5 Disc, 32 State expect 1"
   Solver=minisat(jni) Bitwidth=4 MaxSeq=1 SkolemDepth=1 Symmetry=OFF
   8367 vars. 704 primary vars. 19125 clauses. 119ms.
   . found. Predicate is consistent, as expected. 5912ms.


         ProB takes 640ms to solve 5 Disc problem */
